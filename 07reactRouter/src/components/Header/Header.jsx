...
import {Link, NavLink} from "react-router-dom"; // 'link' use karte hai, 'a' tag nahi. 'a' tag se pura page reload hota hai aur ye hume nahi chahiye. 'NavLink' se active class milta hai.
